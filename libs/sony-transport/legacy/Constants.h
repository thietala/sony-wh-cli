...
inline constexpr unsigned char EQ_SET =
    0x58; // preset: 58 00 <preset> 00 ; custom: 58 00 A0 06 <bass+10> <b1..b5 +10>
...
enum class NC_ASM_SETTING_TYPE_V2 : signed char { NOISE_CANCELLING = 0, AMBIENT_SOUND = 1 };

enum class ASM_SETTING_TYPE : signed char { ON_OFF = 0, LEVEL_ADJUSTMENT = 1 };

enum class ASM_ID : signed char { NORMAL = 0, VOICE = 1 };

enum class NC_DUAL_SINGLE_VALUE : signed char { OFF = 0, SINGLE = 1, DUAL = 2 };

enum class COMMAND_TYPE : signed char { VPT_SET_PARAM = 72, NCASM_SET_PARAM = 104 };
...
inline const SOUND_POSITION_PRESET SOUND_POSITION_PRESET_ARRAY[] = {SOUND_POSITION_PRESET::OFF,
