...
dbus_bool_t read_next_object_path_entry(DBusMessageIter* const iter_object_paths,
...
dbus_bool_t read_next_interface_entry(
    DBusMessageIter* const interface_dict, char** const interface) {
    DBusMessageIter iter_dict_entry;
...
std::string dbus_get_property(
    DBusConnection* const connection, const char* device_path, const char* property) {
