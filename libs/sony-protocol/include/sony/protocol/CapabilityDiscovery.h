...
public:
    ...
    DeviceCapabilities probeDevice(
        IProtocol& protocol, SonyModel model = SonyModel::Unknown, std::string_view address = "");

    [[nodiscard]] std::shared_ptr<CapabilityCache> cache() const noexcept { return _cache; }
